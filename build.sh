...
echo "cp -rf bin/cartoonOnline-release.apk $4/leg_$5_$2.apk"
cp -rf bin/cartoonOnline-release.apk $4/leg-release_$5_$2.apk

}

VERSION=`grep "android:versionName" AndroidManifest.xml | awk -F "\"" '{print $2}'`
TARGET="/Users/michael/Dropbox/apk_backup/leg"
echo $TARGET
rm -rf $TARGET
...
makeChannelApk gfan_leg gfan 10020 $TARGET $VERSION
#makeChannelApk mumayi_邪恶小漫画 mumayi 10070 $TARGET $VERSION
makeChannelApk baidu_leg baidu 10010 $TARGET $VERSION
