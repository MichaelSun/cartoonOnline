...
echo "cp -rf bin/cartoonOnline-release.apk $4/manhua_$5_$2.apk"
cp -rf bin/cartoonOnline-release.apk $4/manhua_$5_$2.apk

}

VERSION=`grep "android:versionName" AndroidManifest.xml | awk -F "\"" '{print $2}'`
TARGET="/Users/michael/Dropbox/apk_backup/manhuaOnline"
echo $TARGET
rm -rf $TARGET
